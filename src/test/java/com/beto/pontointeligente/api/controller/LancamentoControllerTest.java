...
public class LancamentoControllerTest {
	...
	@Test
	public final void testCadastrarLancamento() throws Exception {
	...
	@Test
	public void testRemoverLnacamento() throws Exception {
	...
	private String obterJsonRequisicaoPost() throws JsonProcessingException {
		...
		lancamentoDto.setData(formatDate.format(DATA));
