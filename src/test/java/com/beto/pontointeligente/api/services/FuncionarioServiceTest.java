...
public class FuncionarioServiceTest {
	...
	@Test
	public final void testBuscarPorCpf() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("03406322911");
		assertTrue(funcionario.isPresent());
	}

	@Test
	public final void testBuscarPorEmail() {
