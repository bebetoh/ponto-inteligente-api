package com.beto.pontointeligente.api.dtos;
...
public class FuncionarioDto {
	...
	@NotEmpty(message = "Email não pde ser vazio.")
	...
	public String toString() {
		return "FuncionarioDto [id=" + id + ", nome=" + nome + ", email=" + email + ", senha=" + senha + ", valorHora="
				+ valorHora + ", qtdTrabalhoHorasDia=" + qtdHorasTrabalhoDia + ", qtdHorasAlmoco=" + qtdHorasAlmoco
				+ "]";
	}
